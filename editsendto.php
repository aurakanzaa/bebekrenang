                            ...
                            <div class="bs-example bs-example-tabs orders-tab" role="tabpanel" data-example-id="togglable-tabs">
                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div role="tabpanel" class="tabs-para tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                        ...
                                        <form action="proseseditsend.php" method="post" role="form">
                                            <div class="tab-for-sett">              
                                                <h5>alamat </h5>                                                 
                                                    <input type="text" value="" name="alamat" required="" value="<?php echo $check['alamat'] ?>">
                                                <h5>Kode Pos</h5>                                                   
                                                        <input type="text" value="" name="kodepos" maxlength="5" value="<?php echo $check['kodepos'] ?>">
                                                
                                                <input  type="submit" value="SAVE" name="save">
                                            </div>
                                            <div class="tab-for-sett">
                                                <h5>Kota</h5>                                                   
                                                        <input type="text" value="" name="kota" value="<?php echo $check['kota'] ?>">
                                                <h5>Telp</h5>                                                    
                                                        <input type="text" value="" name="phone" maxlength="12" value="<?php echo $check['phone'] ?>">   
